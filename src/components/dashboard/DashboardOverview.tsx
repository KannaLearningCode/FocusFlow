        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground">Your daily language command center.</p>
                </div>
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent>
                            {["A1", "A2", "B1", "B2", "C1", "C2"].map((l) => (
                                <DropdownMenuItem key={l} onClick={() => setLevel(l as any)}>
                                    {l}
                                </DropdownMenuItem>
                            ))}
                        </DropdownMenuContent>
                ...
                <div className="grid gap-6 md:grid-cols-2 h-[500px]">
                    ...
                    <Card className="flex flex-col h-full">
                        <CardHeader>
                            ...
                            <CardDescription>
                                AI-powered insights tailored to your level ({level}).
                            </CardDescription>
                        </CardHeader>
